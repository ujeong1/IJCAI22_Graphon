...
if __name__ == '__main__':
    ...
    def snow_ball_augmentation(dataset, train_nums, num_augs):
    ...
    new_graph = snow_ball_augmentation(dataset, train_nums, num_augs)
    ...
    # CHOOSE THE VERSION OF AUGMENTATION

    idx_van = np.arange(0, K*num_classes)
    ...
    with open("result_snow.txt", "a") as f:
